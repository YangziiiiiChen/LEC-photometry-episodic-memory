function figure_handles = raster_plot_location_per_epoch(design_mat_name, data_path, type)
...
kernel = ones(1, sliding_window_size) / sliding_window_size;
...
for animal_index = 1:numel(Animals)
    ...
    for epoch = 1:2
        ...
        for i = 1:num_days
            ...
            imagesc(plot_data(sort_idx, :), clims); hold on; box off; axis on;
            colormap("jet");
            clim([-1 1]);
