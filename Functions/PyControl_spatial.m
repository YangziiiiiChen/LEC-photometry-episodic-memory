function PyControl_spatial(design_mat, data_path)
%%
...
save(fullfile(savePath, 'spatial_learning_PC.mat'), 'cue_learning_BA', 'cue_learning_entropy', 'cue_learning_accuracy', 'cue_learning_pokenumber', 'cue_learning_pokescorrect', 'cue_learning_probetest');
